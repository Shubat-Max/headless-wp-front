...
export const SuperiorSlideWrapper = styled.div`
  margin-right: 10px;
  width: 100%;
  padding-bottom: 39%;
  position: relative;
`
export const SuperiorSlideImg = styled.img`
  width: 100%;
  border-radius: 5px;
  user-select: none;
  -webkit-user-drag: none;
`
export const SuperiorSlide = styled.div`
  position: absolute;
  width: 100%; 
  height: 100%;
`
export const SuperiorSliderContainer = styled.div`
  flex: 1;
